...
namespace HairSalon.Tests
{
  ...
  public class StylistTests : IDisposable
  {
    public void Dispose()
    {
      ...
      cmd.ExecuteNonQuery();
      cmd.CommandText = @"ALTER TABLE stylist_client AUTO_INCREMENT = 1;";
      cmd.ExecuteNonQuery();
    ...
    {
      //Arrange, Act
      Stylist firstStylist = new Stylist("Ahmed", "barber", 1);
      Stylist secondStylist = new Stylist("Panata", "hair coloring", 1);
